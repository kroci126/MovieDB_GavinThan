...
//                    bundle.putString("genre",""+nowPlaying.getResults().get(position).getGenre_ids());
                    bundle.putIntegerArrayList("genre", (ArrayList<Integer>) nowPlaying.getResults().get(position).getGenre_ids());
                    bundle.putString("backdrop", ""+nowPlaying.getResults().get(position).getBackdrop_path());
                    bundle.putString("poster", ""+nowPlaying.getResults().get(position).getPoster_path());
                    bundle.putString("vote", ""+nowPlaying.getResults().get(position).getVote_count());
                    bundle.putString("avg",""+nowPlaying.getResults().get(position).getVote_average());
                    bundle.putString("title", ""+nowPlaying.getResults().get(position).getTitle());
                    bundle.putString("date", ""+nowPlaying.getResults().get(position).getRelease_date());
                    bundle.putString("popularity", ""+nowPlaying.getResults().get(position).getPopularity());
