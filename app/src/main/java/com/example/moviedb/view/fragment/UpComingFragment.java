        ...
        public void onChanged(UpComing upComing) {
            ...
            ItemClickSupport.addTo(rv_up_coming).setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
                ...
                public void onItemClicked(RecyclerView recyclerView, int position, View v) {
                    ...
                    bundle.putString("poster", ""+upComing.getResults().get(position).getPoster_path());
                    bundle.putString("vote", ""+upComing.getResults().get(position).getVote_count());
                    bundle.putString("avg",""+upComing.getResults().get(position).getVote_average());
                    bundle.putString("title", ""+upComing.getResults().get(position).getTitle());
                    bundle.putString("date", ""+upComing.getResults().get(position).getRelease_date());
                    bundle.putString("popularity", ""+upComing.getResults().get(position).getPopularity());
